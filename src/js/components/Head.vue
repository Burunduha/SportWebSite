<template>
    <div class="head">
        ...
        <div class="lead">
            <div>
                <h1>Cardio <br>Excercise</h1>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi in qui alias magni fuga quisquam voluptas necessitatibus ducimus totam sed.</p>
            ...
            <div>
                ...
                <div class="lead_info">
                    <div class="lead_info_time">
                        <span>{{ showTime }}</span>
                        ВРЕМЯ
                    </div>
                    <div class="lead_info_cl">
                        <span>165</span>
                        КАЛОРИИ
                    </div>
                </div>
